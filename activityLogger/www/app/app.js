(function() {
    ...
    // 'starter.services' is found in services/
    // 'starter.controllers' is found in controllers/
    angular
        .module('ActivityLogger', ['ionic', 'firebase'])
        ...
        .config(function($stateProvider, $urlRouterProvider) {
            ...
            $stateProvider
                ...
                .state('tab.activity', {
                    url: '/activity/:type/:comment/:competitionModus/:selectedOpponentId/:competitionDisciplin',
                    views: {
                        'tab-main': {
