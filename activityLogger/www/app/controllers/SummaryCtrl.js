		...
		.controller(
				...
				function($scope, $window, Activity, SummaryService) {
					...
					$scope.showWeekCharts = function() {
						...
						drawLineChart(weekdays, data_time, "chart_times_week");

						// draw distance chart
						var data_dist = SummaryService.getDistances(7);
						drawLineChart(weekdays, data_dist, "chart_dist_week");

						// draw calories chart
						var data_kcal = SummaryService.getCalories(7);
						drawLineChart(weekdays, data_kcal, "chart_kcal_week");
					};
					 ...
					 * 
					 */
					$scope.showDisciplineDistributionChart = function(period) {
