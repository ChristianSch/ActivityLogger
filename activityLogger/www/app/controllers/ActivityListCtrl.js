...
(function() {
    ...
    angular.module('ActivityLogger').controller('ActivityListCtrl',
        function($state, $ionicPopup, $scope, $ionicPopover, Activity, Track, TrackRecord, DataService) {
            ...
            this.activities = [];
            this.activities.push(new Activity(1, 'Laufen', 13, 14, track1, 'Erster Dummy'));
            this.activities.push(new Activity(2, 'Laufen', 15, 16, track2, 'Zweiter Dummy'));
            this.activities.push(new Activity(3, 'Radfahren', 17, 18, track3, 'Dritter Dummy'));
